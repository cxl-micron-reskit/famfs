...
** TODO Create log entry when allocating/creating a file
...
** TODO create files of arbitrary sizes
** TODO randomize file content based on supplied key (so files can be verified)
