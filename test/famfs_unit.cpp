...
TEST(famfs, famfs_mkfs)
{
	...
	rc = __famfs_mkfs("/dev/dax0.0", sb, logp, 1, FAMFS_ALLOC_UNIT, device_size, 0, 0);
	ASSERT_NE(rc, 0);
	...
	rc = __famfs_mkfs("/dev/dax0.0", sb, logp, FAMFS_LOG_LEN, FAMFS_ALLOC_UNIT, device_size, 1, 1);
	ASSERT_EQ(rc, 0);
	...
	rc = __famfs_mkfs("/dev/dax0.0", sb, logp, FAMFS_LOG_LEN, FAMFS_ALLOC_UNIT, device_size, 1, 0);
	ASSERT_EQ(rc, 0);
